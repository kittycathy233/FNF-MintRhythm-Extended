...
class VUIRadioGroup extends FlxSpriteGroup
{
	...
	public var checkedRadio(default, set):VUIRadioItem;
	...
	function set_checkedRadio(v:VUIRadioItem)
	{
		checkedRadio = null;
	...
	{
		var radio:VUIRadioItem = cast recycle(VUIRadioItem);
		radio.onClick = function() {
			checkedRadio = radio;
			if(onClick != null) onClick();
			if(broadcastRadioGroupEvent) VUIEventHandler.event(CLICK_EVENT, this);
		};
...
class VUIRadioItem extends VUICheckBox
{
