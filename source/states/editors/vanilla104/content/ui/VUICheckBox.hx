...
class VUICheckBox extends FlxSpriteGroup
{
	...
	{
		box.loadGraphic(Paths.image('vanilla104-ui/checkbox', 'shared'), true, 16, 16);
	...
	override function update(elapsed:Float)
	{
		...
		if(FlxG.mouse.justPressed)
		{
				...
				(mousePos.y >= screenPos.y && mousePos.y < screenPos.y + height))
			{
				...
				if(broadcastCheckBoxEvent) VUIEventHandler.event(CLICK_EVENT, this);
			}
		}
	}
