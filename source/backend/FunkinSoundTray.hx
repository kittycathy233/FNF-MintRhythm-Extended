...
class FunkinSoundTray extends FlxSoundTray
{
	...
	public function new()
	{
		...
		var bg:Bitmap = new Bitmap(getImage("images/soundtray/Funkin/volumebox"));
		...
		var backingBar:Bitmap = new Bitmap(getImage('images/soundtray/Funkin/bars_10'));
		backingBar.x = 9;
		backingBar.y = 5;
		...
		for (i in 1...11)
		{
			var bar:Bitmap = new Bitmap(getImage('images/soundtray/Funkin/bars_$i'), false);
			bar.x = 9;
			bar.y = 5;
	...
	function getSound(path):openfl.media.Sound
	{
		...
		final key:String = 'soundtray/Funkin/$path';
